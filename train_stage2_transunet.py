...
from models import discriminator_2d, transunet_2d
...
def init_parameters():
    ...
    tc.model_path = 'L:/Regstain_Code/code/stage2_20231001_transunet/'
    tc.prev_checkpoint_path = None
    # tc.prev_checkpoint_path = 'L:/Regstain_Code/code/stage2_20231001_transunet/'
    ...
    tc.valid_steps = 300  # perform validation when D_steps % valid_steps == 0 or at the end of a loop of (train G/D, train R)
...
if __name__ == '__main__':
    ...
    if tc.prev_checkpoint_path:
        model_G.load_weights(tc.prev_checkpoint_path + '/model_G_iter=13300.h5')
        model_D.load_weights(tc.prev_checkpoint_path + '/model_D_iter=13300.h5')
        model_R.load_weights(tc.prev_checkpoint_path + '/model_R_iter=13300.h5')
