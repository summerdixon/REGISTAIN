...
from batch_utils_fortransplant import ImageTransformationBatchLoader_Testing
import time


def init_parameters():
    tc, vc = ConfigObj(), ConfigObj()
    tc.image_path = 'F:\\Tairan\\Batch2_Lung_HE_dataset\\Third_reg_crop_nobleach\\Testing\\SP18-4368-001\\target\\*.mat'
    vc.image_path = 'F:\\Tairan\\Batch2_Lung_HE_dataset\\Third_reg_crop_nobleach\\Testing\\SP18-4368-001\\target\\*.mat'
...
if __name__ == '__main__':
    ...
    model_path = 'M:/Regstain_Code/code/stage2_20241213_TransplantDatainitIter=0'
    checkpoint_path = model_path + '/model_G_iter=38600.h5'
    output_path = model_path + '/outputs_G_iter=38600_SP18-4368-001/'
