...
def init_parameters():
    ...
    tc.image_path = 'Y:\\covid_dataset_test_revision\\Test_Region2\\AAW-19-00003-A9\\input\\*.mat'
    vc.image_path = 'Y:\\covid_dataset_test_revision\\Test_Region2\\AAW-19-00003-A9\\input\\*.mat'
    ...
    tc.image_size, vc.image_size = 3248, 3248   # 1408, 1408
...
if __name__ == '__main__':
    ...
    model_path = 'L:/Regstain_Code/code/stage2_20220727_G&RSeperateTrain_initIter=0'
    checkpoint_path = model_path + '/model_G_iter=87700.h5'
    output_path = model_path + '/outputs_G_iter=87700_AAW-19-00003-A9_full/'
