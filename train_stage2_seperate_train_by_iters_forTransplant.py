...
from batch_utils_fortransplant import ImageTransformationBatchLoader, Her2data_splitter
...
def init_parameters():
    ...
    tc.model_path = 'M:/Regstain_Code/code/stage2_20241213_TransplantDatainitIter=0/'
    # tc.prev_checkpoint_path = None
    tc.prev_checkpoint_path = 'M:/Regstain_Code/code/stage2_20220727_G&RSeperateTrain_initIter=0/'
    ...
    tc.image_path_1 = 'F:/Tairan/Batch2_Lung_HE_dataset/Third_reg_crop_nobleach/Training/SP*/target/*.mat'
    vc.image_path_1 = 'F:/Tairan/Batch2_Lung_HE_dataset/Third_reg_crop_nobleach/Testing/SP*/target/*.mat'
...
if __name__ == '__main__':
    ...
    train_images = glob.glob(tc.image_path_1)
    valid_images = glob.glob(vc.image_path_1)
    ...
    if tc.prev_checkpoint_path:
        model_G.load_weights(tc.prev_checkpoint_path + '/model_G_iter=87700.h5')
        model_D.load_weights(tc.prev_checkpoint_path + '/model_D_iter=87700.h5')
        model_R.load_weights(tc.prev_checkpoint_path + '/model_R_iter=87700.h5')
