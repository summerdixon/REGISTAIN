...
from models import discriminator_2d, swin_unet_2d
...
def init_parameters():
    ...
    tc.model_path = 'L:/Regstain_Code/code/stage2_20231001_swinunet/'
...
if __name__ == '__main__':
    ...
    # ======================= model ========================= 
    model_G = swin_unet_2d((tc.image_size, tc.image_size, tc.num_slices), 
                           filter_num_begin=tc.n_channels, n_labels=tc.label_channels, 
                            depth=4, stack_num_down=3, stack_num_up=3, 
                            patch_size=(4, 4), num_heads=[4, 8, 16, 16], window_size=[4, 2, 2, 2], num_mlp=3072, 
                            output_activation=None, shift_window=True, name='swin_unet')
